...
foreach($names as $name){
	if($name->name != 'A_ID' && $name->name != 'Fac_ID' && $name->name != 'Brochure_copy' && $name->name != 'Permission_copy' && $name->name != 'Certificate_copy' && $name->name != 'Report_copy' && $name->name != 'Mobile' && $name->name != 'Email' && $name->name != 'Password' && $name->name != 'token' && $name->name != 'Dept' )
